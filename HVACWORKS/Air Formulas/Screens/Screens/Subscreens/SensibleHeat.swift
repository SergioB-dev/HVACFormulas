...
struct SensibleHeat: View {
    ...
    var body: some View {
        VStack {
            ...
            NumberEntryView(firstEntry: $firstEntry, secondEntry: $secondEntry, selection: .constant(0), firstEntryPlaceHolder: "Temperature difference ∆", secondEntryPlaceHolder: "Cubic Feet per Minute", isLatentHeat: false) {
                self.hideKeyboard()
